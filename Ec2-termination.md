  -----------------------------------------------------------------------
  **Prepared by**   **Krishnaveni     **Reviewed by**   **Loknath Panda**
                    Linga**                             
  ----------------- ----------------- ----------------- -----------------
  **Date**          **20-03-2026**    **Date**          **21-03-2026**
...
**Purpose:** Instances which are in stopped state are terminated because
these are not required.

**Introduction:** Ec2 Instances are virtual machines that are used to
...
-   Volumes also will not there in volumes
